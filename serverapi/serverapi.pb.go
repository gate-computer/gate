...
import (
	fmt "fmt"
	manifest "gate.computer/gate/internal/manifest"
...
func (State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{0}
}
...
func (Cause) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{1}
}
...
func (DebugOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{2}
}
...
type Status struct {
	State  State  `protobuf:"varint,1,opt,name=state,proto3,enum=gate.serverapi.State" json:"state,omitempty"`
	Cause  Cause  `protobuf:"varint,2,opt,name=cause,proto3,enum=gate.serverapi.Cause" json:"cause,omitempty"`
...
func (*InstanceStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{3}
}
...
func (*Instances) Descriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{4}
}
...
type DebugRequest struct {
	Op     DebugOp     `protobuf:"varint,1,opt,name=op,proto3,enum=gate.serverapi.DebugOp" json:"op,omitempty"`
...
func (*DebugRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{5}
}
...
func (*DebugResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{6}
}
...
type DebugConfig struct {
	...
	Breakpoints manifest.Breakpoints `protobuf:"bytes,2,opt,name=breakpoints,proto3" json:"breakpoints"`
}
...
func (*DebugConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_019e605983a3cfc7, []int{7}
}
...
func init() {
	proto.RegisterEnum("gate.serverapi.State", State_name, State_value)
	proto.RegisterEnum("gate.serverapi.Cause", Cause_name, Cause_value)
	proto.RegisterEnum("gate.serverapi.DebugOp", DebugOp_name, DebugOp_value)
	proto.RegisterType((*ModuleRef)(nil), "gate.serverapi.ModuleRef")
	proto.RegisterType((*ModuleRefs)(nil), "gate.serverapi.ModuleRefs")
	proto.RegisterType((*Status)(nil), "gate.serverapi.Status")
	proto.RegisterType((*InstanceStatus)(nil), "gate.serverapi.InstanceStatus")
	proto.RegisterType((*Instances)(nil), "gate.serverapi.Instances")
	proto.RegisterType((*DebugRequest)(nil), "gate.serverapi.DebugRequest")
	proto.RegisterType((*DebugResponse)(nil), "gate.serverapi.DebugResponse")
	proto.RegisterType((*DebugConfig)(nil), "gate.serverapi.DebugConfig")
}

func init() { proto.RegisterFile("serverapi/serverapi.proto", fileDescriptor_019e605983a3cfc7) }

var fileDescriptor_019e605983a3cfc7 = []byte{
	// 889 bytes of a gzipped FileDescriptorProto
	,
}
		...
		for iNdEx := len(m.Modules) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintServerapi(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func skipServerapi(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupServerapi
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupServerapi = fmt.Errorf("proto: unexpected end of group")
)
