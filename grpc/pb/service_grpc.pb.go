...
const (
	Root_Init_FullMethodName = "/gate.grpc.Root/Init"
)
...
var Root_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/pb/service.proto",
}

const (
	Instance_Create_FullMethodName   = "/gate.grpc.Instance/Create"
	Instance_Receive_FullMethodName  = "/gate.grpc.Instance/Receive"
	Instance_Handle_FullMethodName   = "/gate.grpc.Instance/Handle"
	Instance_Shutdown_FullMethodName = "/gate.grpc.Instance/Shutdown"
	Instance_Suspend_FullMethodName  = "/gate.grpc.Instance/Suspend"
	Instance_Snapshot_FullMethodName = "/gate.grpc.Instance/Snapshot"
)
...
var Instance_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gate.grpc.Instance",
