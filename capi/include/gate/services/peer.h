...
static inline void peer_send_message_packet(
	void *buf, size_t size, int16_t code, uint64_t peer_id)
{
...
static inline void peer_send_message(
	int16_t code, uint64_t peer_id, const void *msg, size_t msglen)
{
