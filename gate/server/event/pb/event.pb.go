...
var file_gate_server_event_pb_event_proto_goTypes = []any{
...
func file_gate_server_event_pb_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_gate_server_event_pb_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Fail); i {
			case 0:
				return &v.state
			case 1:
		...
		file_gate_server_event_pb_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Module); i {
			case 0:
				return &v.state
			case 1:
		...
		file_gate_server_event_pb_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_gate_server_event_pb_event_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
	...
	file_gate_server_event_pb_event_proto_msgTypes[3].OneofWrappers = []any{
		(*Event_Fail)(nil),
		(*Event_Module)(nil),
		(*Event_Instance)(nil),
	}
