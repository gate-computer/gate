...
func (*ByteRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_b1049dab89f71c97, []int{0}
}
...
func (*Program) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_b1049dab89f71c97, []int{1}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_b1049dab89f71c97, []int{2}
}
...
func (*Function) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_b1049dab89f71c97, []int{3}
}
...
func (*Snapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_b1049dab89f71c97, []int{4}
}
...
func init() {
	proto.RegisterFile("image/internal/manifest/manifest.proto", fileDescriptor_manifest_b1049dab89f71c97)
}

var fileDescriptor_manifest_b1049dab89f71c97 = []byte{
	// 788 bytes of a gzipped FileDescriptorProto
	,
}
