...
package webserverapi // import "gate.computer/gate/internal/webserverapi"

import proto "github.com/gogo/protobuf/proto"
import fmt "fmt"
import math "math"
import serverapi "gate.computer/gate/serverapi"
...
func (*IOConnection) Descriptor() ([]byte, []int) {
	return fileDescriptor_webserverapi_50dc130b49d2a316, []int{0}
}
...
func (*ConnectionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_webserverapi_50dc130b49d2a316, []int{1}
}
...
func init() {
	proto.RegisterFile("internal/webserverapi/webserverapi.proto", fileDescriptor_webserverapi_50dc130b49d2a316)
}

var fileDescriptor_webserverapi_50dc130b49d2a316 = []byte{
