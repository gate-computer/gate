...
const (
	...
	Status_RUNNING     Status_State = 1
	Status_hibernating Status_State = 2
	Status_HIBERNATING Status_State = 2
...
var Status_State_name = map[int32]string{
	...
	2: "hibernating",
	// Duplicate value: 2: "HIBERNATING",
	3: "terminated",
	// Duplicate value: 3: "TERMINATED",
}
...
func (Status_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{2, 0}
}

type Status_Cause int32

const (
	Status_TRAP      Status_Cause = 0
	Status_kill      Status_Cause = 1
	Status_KILL      Status_Cause = 1
	Status_violation Status_Cause = 2
	Status_VIOLATION Status_Cause = 2
)
...
var Status_Cause_name = map[int32]string{
	0: "TRAP",
	1: "kill",
	// Duplicate value: 1: "KILL",
	2: "violation",
	// Duplicate value: 2: "VIOLATION",
}
...
func (Status_Cause) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{2, 1}
}

type Status_TrapId int32

const (
	Status_EXIT Status_TrapId = 0
	// JSON:
	Status_no_function                       Status_TrapId = 1
	Status_suspended                         Status_TrapId = 2
	Status_unreachable                       Status_TrapId = 3
	Status_call_stack_exhausted              Status_TrapId = 4
	Status_memory_access_out_of_bounds       Status_TrapId = 5
	Status_indirect_call_index_out_of_bounds Status_TrapId = 6
	Status_indirect_call_signature_mismatch  Status_TrapId = 7
	Status_integer_divide_by_zero            Status_TrapId = 8
	Status_integer_overflow                  Status_TrapId = 9
)

var Status_TrapId_name = map[int32]string{
	0: "EXIT",
	1: "no_function",
	2: "suspended",
	3: "unreachable",
...
var Status_TrapId_value = map[string]int32{
	"EXIT":                              0,
	"no_function":                       1,
	"suspended":                         2,
	"unreachable":                       3,
...
func (x Status_TrapId) String() string {
	return proto.EnumName(Status_TrapId_name, int32(x))
}
func (Status_TrapId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{2, 2}
}
...
func (*ModuleRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{0}
}
...
func (*ModuleRefs) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{1}
}
...
type Status struct {
	...
	Trap  Status_TrapId `protobuf:"varint,3,opt,name=trap,proto3,enum=server.Status_TrapId" json:"trap,omitempty"`
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{2}
}
...
func (*InstanceStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{3}
}
...
func (*Instances) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{4}
}
...
func (*IOConnection) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{5}
}
...
func (*ConnectionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_serverapi_41bfd3b4c4acaa11, []int{6}
}
...
func init() {
	...
	proto.RegisterEnum("server.Status_TrapId", Status_TrapId_name, Status_TrapId_value)
}
...
func (m *Status) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Trap != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintServerapi(dAtA, i, uint64(m.Trap))
	}
	if m.Exit != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintServerapi(dAtA, i, uint64(m.Exit))
	}
	if len(m.Error) > 0 {
		dAtA[i] = 0x2a
		i++
...
func (m *Status) Size() (n int) {
	...
	if m.Trap != 0 {
		n += 1 + sovServerapi(uint64(m.Trap))
	}
	if m.Exit != 0 {
		n += 1 + sovServerapi(uint64(m.Exit))
	}
	l = len(m.Error)
	if l > 0 {
		n += 1 + l + sovServerapi(uint64(l))
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Trap |= (Status_TrapId(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("internal/serverapi/serverapi.proto", fileDescriptor_serverapi_41bfd3b4c4acaa11)
}

var fileDescriptor_serverapi_41bfd3b4c4acaa11 = []byte{
	// 698 bytes of a gzipped FileDescriptorProto
	,
}
