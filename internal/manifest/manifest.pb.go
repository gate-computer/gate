...
func (*ByteRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_0472106dacafe4c5, []int{0}
}
...
type Program struct {
	...
	VersionSection            ByteRange         `protobuf:"bytes,11,opt,name=version_section,json=versionSection" json:"version_section"`
...
func (*Program) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_0472106dacafe4c5, []int{1}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_0472106dacafe4c5, []int{2}
}
...
func (m *Program) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x5a
	i++
	i = encodeVarintManifest(dAtA, i, uint64(m.VersionSection.Size()))
	n1, err := m.VersionSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n1
...
func (m *Program) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VersionSection", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.VersionSection.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func init() {
	proto.RegisterFile("internal/manifest/manifest.proto", fileDescriptor_manifest_0472106dacafe4c5)
}

var fileDescriptor_manifest_0472106dacafe4c5 = []byte{
	// 677 bytes of a gzipped FileDescriptorProto
	,
}
