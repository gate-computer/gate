...
func (*ByteRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_9087363cc520fd50, []int{0}
}
...
func (*Archive) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_9087363cc520fd50, []int{1}
}
...
func init() {
	proto.RegisterFile("internal/manifest/manifest.proto", fileDescriptor_manifest_9087363cc520fd50)
}

var fileDescriptor_manifest_9087363cc520fd50 = []byte{
	// 573 bytes of a gzipped FileDescriptorProto
	,
}
