...
func (*ByteRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_d63e6836e6e1a87a, []int{0}
}
...
type Program struct {
	...
	FlagSection          ByteRange         `protobuf:"bytes,11,opt,name=flag_section,json=flagSection" json:"flag_section"`
	ServiceSection       ByteRange         `protobuf:"bytes,12,opt,name=service_section,json=serviceSection" json:"service_section"`
	IoSection            ByteRange         `protobuf:"bytes,13,opt,name=io_section,json=ioSection" json:"io_section"`
	BufferSection        ByteRange         `protobuf:"bytes,14,opt,name=buffer_section,json=bufferSection" json:"buffer_section"`
	StackSection         ByteRange         `protobuf:"bytes,15,opt,name=stack_section,json=stackSection" json:"stack_section"`
	GlobalTypes          []byte            `protobuf:"bytes,16,opt,name=global_types,json=globalTypes,proto3" json:"global_types,omitempty"`
	...
	RandomSeed           bool              `protobuf:"varint,21,opt,name=random_seed,json=randomSeed,proto3" json:"random_seed,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*Program) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_d63e6836e6e1a87a, []int{1}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_manifest_d63e6836e6e1a87a, []int{2}
}
...
func (m *Program) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x5a
	i++
	i = encodeVarintManifest(dAtA, i, uint64(m.FlagSection.Size()))
	n1, err := m.FlagSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n1
	...
	n2, err := m.ServiceSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
	...
	n3, err := m.IoSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	...
	n4, err := m.BufferSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	...
	n5, err := m.StackSection.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
...
func (m *Program) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlagSection", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FlagSection.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func init() {
	proto.RegisterFile("internal/manifest/manifest.proto", fileDescriptor_manifest_d63e6836e6e1a87a)
}

var fileDescriptor_manifest_d63e6836e6e1a87a = []byte{
	// 678 bytes of a gzipped FileDescriptorProto
	,
}
